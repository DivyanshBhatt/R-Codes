...
input_csv.df <- read.csv(file="C:\\Users\\admin\\Desktop\\MICA\\AMMA\\DATA\\data_2017\\binary.csv")
...
bank_ins = read.sas7bdat("C:\\Users\\admin\\Desktop\\MICA\\AMMA\\DATA\\data_2017\\binary.csv")
names(bank_ins)
...
write.csv(tt, "C:\\Users\\admin\\Desktop\\MICA\\AMMA\\DATA\\data_2017\\mtcars.csv",
          row.names=F
)
